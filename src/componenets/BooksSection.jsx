...
const BooksSection = ({ title }) => {
  ...
  // Auto-scroll: step every 4 seconds
  const AUTO_RESUME_DELAY_MS = 4000; // delay before resuming auto-scroll after interaction
  const AUTO_INTERVAL_MS = 4000; // step interval
  ...
  // Pause auto-scroll temporarily (e.g., after arrow click/drag/wheel)
