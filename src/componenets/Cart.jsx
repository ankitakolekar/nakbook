...
//             <button className="bg-gray-400 px-4 py-2 rounded-lg text-white hover:bg-gray-500">
//               Update cart
//             </button>
//           </div>
//         </div>
...
//               भारतीय पोस्ट यांनी त्यांच्या दरात टिपट <br /> वाढ केल्याने 80% डिलिव्हरी चार्जेस <br /> आम्ही भरत असून 20% चार्जेस <br /> ग्राहकांकडून घेत आहोत. <br /> शिपिंग: ₹{shippingCharge}
//               <p className="text-sm">
...
//           </div>
//           <a href="/checkout" className="w-full mt-4 bg-blue-900 text-white py-2 rounded-full hover:bg-blue-800">
//             Proceed to checkout
//           </a>
//         </div>
//       </div>
