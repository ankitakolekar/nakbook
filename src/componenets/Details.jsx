...
//           <img
//             src=""
//             className="w-full rounded-lg bg-yellow-200 h-full border border-black "
//           />
//         </div>

//         <div className="md:w-1/2 flex justify-center flex-col items-center">
//           <h2 className="text-xl font-semibold">Indian Governance Tatha Bhartiya Prashasan</h2>
//           <p className="text-green-600 font-medium mt-2">IN STOCK</p>
//           <p className="mt-2 text-lg font-bold text-blue-800">
//             ₹380.00 <span className="line-through text-sm text-gray-500">₹475.00</span>
//           </p>
//           <p className="mt-4 text-gray-700">
//             indian governance tatha bhartiya prashasan k sagar
//           </p>

//           <div className="flex items-center gap-3 mt-6">
//             <button className="bg-blue-900 text-white px-4 py-2 rounded">Add to Cart</button>
