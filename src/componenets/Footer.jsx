...
// function Footer() {
//   // useEffect(()=>{
//   //   console.log("the component is created of footer....");
  
//   //   return ()=>{
//   //     console.log("the component is deleted of footer...");
//   //   }
//   // });

//   return (
//     <>
//     <footer class="bg-white border-t border-neutral-200 pt-10 pb-6 text-gray-800">
//   <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-5 gap-8">
    
//     {/* <!-- Logo & Contact --> */}
//     <div>
//       <img src={logo} alt="Nakshatra Book Depo" class="h-[80px]" />
//       <p class="text-base font-medium mt-4">Got Questions? Call us!</p>
//       <p class="text-3xl font-bold text-[#011E41]">0241 3590019</p>
//       <div class="mt-4 flex items-center gap-2 text-blue-600 hover:text-[#051d38] font-medium cursor-pointer">
//         <FaTelegramPlane />
...
//     {/* <!-- Contact Info --> */}
//     <div>
//       <h3 class="font-semibold mb-2 text-2xl">Contact Info</h3>
//       <p class="text-base text-gray-600">Nakshatra Books, Shani Chowk,<br/>Ahmednagar, Maharashtra 414001</p>
//       <p class="text-base text-gray-600 mt-2">Monday – Friday: 9:30am–09:00pm</p>
//       <p class="mt-2 text-base font-medium">help@nakbook.com</p>
//     </div>

//     {/* <!-- Explore --> */}
//     <div>
//       <h3 class="font-semibold text-2xl mb-2">Explore</h3>
//       <ul class="space-y-1 text-base text-gray-600">
//         <li>Bookshelf</li>
//         <li>My Account</li>
//         <li>My Orders</li>
//         <li>Track Product</li>
...
//     {/* <!-- Help --> */}
//     <div>
//       <h3 class="font-semibold text-2xl mb-2">Help & Info</h3>
//       <ul class="space-y-1 text-base text-gray-600">
...
//     {/* <!-- Categories --> */}
//     <div>
//       <h3 class="font-semibold text-2xl mb-2">Categories</h3>
//       <ul class="space-y-1 text-base text-gray-600">
//         <li>Marathi Grammar</li>
...
//     © 2023 Nakshatra Book Depo. Crafted & Cared by Neo tech.
//   </div>
// </footer>
