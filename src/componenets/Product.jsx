...
//     // ✅ All products for sidebar & main content
//     const products = [
//         {
//             id: 1,
...
//         {
//             id: 4,
//             title: "mathematics (tricks and techniques) by Pandharinath Rane Sir~Prerana Publication",
//             price: 350,
//             oldPrice: 500,
//             inStock: true,
...
//                             <p
//                                 className={`text-xs font-semibold tracking-wide ${selectedProduct.inStock ? "text-green-600" : "text-red-600"
//                                     }`}
//                             >
...
//                                         {/* <div className="absolute inset-0 bg-black bg-opacity-30 flex flex-col justify-center items-end gap-3 pr-3 opacity-0 group-hover:opacity-100 transition"> */}
...
//                                             <a href="#" className="bg-white p-2 rounded-full shadow hover:scale-110 transition pointer-events-auto">
//                                                 <HeartIcon className="h-3 w-3 text-gray-700" />
//                                             </a>
...
//                                             </a>
//                                             <a href="#" className="bg-white p-2 rounded-full shadow hover:scale-110 transition pointer-events-auto">
//                                                 <ShoppingBagIcon className="h-3 w-3 text-gray-700" />
//                                             </a>
...
//                         {/* This could be your "Ask for Book" trigger */}
//                         <div
//                             onClick={handleOpen}
//                             style={{
//                                 cursor: "pointer",
...
//                                     }}
//                                 >
//                                     <h2>DEPT.PSI Purv Pariksha Thokala</h2>
//                                     <p>by Amir Shaikh Sir – Prime Publication</p>
//                                     <p>
//                                         <strong>₹99.00</strong> <del>₹499.00</del>
//                                     </p>
//                                     <button
//                                         style={{
//                                             background: "#1e3a8a",
...
//                                         onClick={handleClose}
//                                     >
//                                         <a href="http://localhost:3000/cart">Add to cart</a>
//                                     </button>
//                                 </div>
//                             </div>
//                         )}
